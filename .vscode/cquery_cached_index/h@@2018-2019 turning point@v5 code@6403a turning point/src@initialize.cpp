...
std::string getAutonomousName(){
	...
	if(A.get_value() == 1 && F.get_value() == 1){myAutonomousName = "Blue Front";}
	else if(B.get_value() == 1 && F.get_value() == 1){myAutonomousName = "Blue Back";}
	else if(C.get_value() == 1 && F.get_value() == 1){myAutonomousName = "9";}
	else if(D.get_value() == 1 && F.get_value() == 1){myAutonomousName = "10";}
	else if(E.get_value() == 1 && F.get_value() == 1){myAutonomousName = "11";}
	else if(A.get_value() == 1){myAutonomousName = "Red Front";}
	else if(B.get_value() == 1){myAutonomousName = "Red Back";}
	else if(C.get_value() == 1){myAutonomousName = "3";}
	else if(D.get_value() == 1){myAutonomousName = "4";}
	else if(E.get_value() == 1){myAutonomousName = "5";}
	else if(F.get_value() == 1){myAutonomousName = "Skills";}
	else{myAutonomousName = "Test";}
